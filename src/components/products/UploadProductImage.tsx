...
const UploadProductImage = ({ currencyImage }: { currencyImage?: string }) => {
    ...
    <>
      ...
      <div className="space-y-1">
        ...
        >
          ...
          {isDragReject && <p>Archivo no tiene formato válido</p>}
      ...
      {currencyImage && !image && (
        <div className="py-5 space-y-3">
          ...
          <div className="w-[300px] h-[300px] relative">
            <Image
              src={getImagePath(currencyImage)}
              alt="Imagen publicada"
              className="object-cover"
              fill
            />
      ...
      <input
        type="hidden"
        name="image"
        defaultValue={image ? image : currencyImage}
      />
    </>
  );
};
